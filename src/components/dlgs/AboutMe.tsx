...
export default function AboutMe({ show, setShow, setShowProjects}: AboutMeProps) {
    if(!show) return <></>
    return <div className="flex justify-center fixed w-screen h-screen">
        ...
        <div className="relative w-[500px] h-1/2 mt-[200px] bg-[rgb(31_31_31)] rounded-xl overflow-hidden z-1">
            ...
            <div className="w-full flex justify-center mt-[20px]">
                ...
                <button className="text-white w-1/3 h-[40px] border border-white rounded-4xl cursor-pointer">
                    Contact
                </button>
            </div>
        </div>
