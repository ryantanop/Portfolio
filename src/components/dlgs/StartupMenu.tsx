...
export default function StartupMenu({ open, setClose }: StartupMenuProps) {
    ...
    return <div className="flex justify-center fixed w-screen h-screen left-0 top-0">
        ...
        <div className="transition-all duration-300 absolute w-[470px] bottom-[70px] rounded-xl backdrop-blur-lg border border-gray-600 overflow-hidden" style={{ height: expanded ? '500px' : '200px' }}>
            ...
            <div className="transition-all bg-black/20 duration-300 w-full h-[300px] overflow-hidden" style={{ height: expanded ? '300px' : '0px' }}>
                <p className="w-full text-center text-white py-[10px]">Phone: +1(929) 233 9817</p>
                <div className="w-full h-[3px] px-[10px]">
                    <div className="w-full h-full bg-gray-200"></div>
                </div>
                <p className="w-full text-center text-white py-[10px]">Email: loi.nguyen.eng11@gmail.com</p>
                <div className="w-full h-[3px] px-[10px]">
                    <div className="w-full h-full bg-gray-200"></div>
                </div>
                <p className="w-full text-center text-white py-[10px]">LinkedIn: https://linkedin.com/loinguyen</p>
            </div>
            <div className="flex items-center w-full bg-black/50 h-[50px] cursor-pointer text-white " onClick={() => setExpanded(!expanded)}>
                <p className="flex justify-center w-full">Loi Nguyen: Software Engineer | Tech Lead</p>
            </div>
        </div>
    </div>
}
